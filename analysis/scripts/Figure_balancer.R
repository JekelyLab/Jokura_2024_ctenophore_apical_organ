...
balancer_Q1 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:balancer", "Q1")))
balancer_Q2 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:balancer", "Q2")))
balancer_Q3 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:balancer", "Q3")))
balancer_Q4 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:balancer", "Q4")))
intramulticilia <- read_smooth_cell("celltype:intra-multi-ciliated")
lamellate <- read_smooth_cell("celltype:lamellate")
bridge <- read_smooth_cell("celltype:bridge")
...
lamellate_Q3 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:lamellate", "Q3")))
intramulticilia_Q3 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:intra-multi-ciliated", "Q3")))
Cgroove_tag_Q3 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:Cgroove-tag", "Q3")))
Cgroove_sag_Q3 <- read_smooth_cell(get_skids_with_annot(pid = 35, c("celltype:Cgroove-sag", "Q3")))
